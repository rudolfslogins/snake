...
function () {
  ...
  Grid.prototype.seed = function (snake) {
    for (; this.apples.length < this.configuration.level + this.configuration.apples;) {
      var randX = Math.floor(Math.random() * _Configuration.CELLS_HORIZONTAL);
      var randY = Math.floor(Math.random() * _Configuration.CELLS_VERTICAL);
...
function () {
  ...
  GameUI.prototype.drawLevel = function (context) {
    context.font = 35 * SCALE + "px Arial";
    context.textAlign = "left";
    context.textBaseline = "top";
    context.fillStyle = "rgba(255,255,255,0.75)";
  ...
  GameUI.prototype.drawGameState = function (context) {
    context.font = 35 * SCALE + "px Arial";
    context.textAlign = "left";
    context.textBaseline = "top";
